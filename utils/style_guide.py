...
DEFAULT_COLUMN_CONFIGS = {
    ...
    "Type (Peg Mechanism)": st.column_config.TextColumn(
        "Type (Peg Mechanism)", help="Mechanism used for pegging"
    ),
    "Description": st.column_config.TextColumn(
        "Description", help="Details about the yield source"
    ),
    ...
    "Staked Proportion": st.column_config.TextColumn(
        "Staked %", help="Percentage of tokens staked"
    ),
    "Strategy Type": st.column_config.TextColumn(
        "Strategy Type", help="Yield generation strategy category"
    ),
}
...
def format_card(title: str, content: str, color: Optional[str] = None) -> None:
    """
