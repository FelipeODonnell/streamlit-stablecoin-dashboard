...
def show_stablecoin_analytics():
    ...
    if data_valid and not enhanced_analytics_data.empty:
        ...
        try:
            if 'TVL_USD' in enhanced_analytics_data.columns and 'APY' in enhanced_analytics_data.columns:
                ...
                st.warning("Required columns (TVL_USD, APY, Project, Asset Symbol) not found for scatter plot.")
        except Exception as e:
