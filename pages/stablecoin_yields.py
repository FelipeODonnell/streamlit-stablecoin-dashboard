...
def show_stablecoin_yields():
    ...
    data_valid = not (isinstance(stablecoin_yield_data, pd.DataFrame) and
                      ('error' in stablecoin_yield_data.columns or 
                       'warning' in stablecoin_yield_data.columns))
    ...
    if data_valid and not stablecoin_yield_data.empty:
        ...
        filtered_data['Strategy Type'] = filtered_data['Description'].apply(categorize_stablecoin_by_strategy)
